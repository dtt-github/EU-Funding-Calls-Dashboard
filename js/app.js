(function () {
  ...
  const SYNONYMS = {
    'construction':     ['manufacturing', 'material', 'production', 'infrastructure', 'building', 'steel', 'cement', 'industrial', 'civil engineering'],
    'building':         ['construction', 'infrastructure', 'material', 'manufacturing'],
    'infrastructure':   ['construction', 'building', 'water', 'transport', 'urban', 'road'],
    'ai':               ['artificial intelligence', 'machine learning', 'digital', 'robot', 'automation', 'intelligent', 'data', 'GenAI'],
    'artificial intelligence': ['ai', 'machine learning', 'digital', 'robot', 'deep learning'],
    'machine learning': ['ai', 'artificial intelligence', 'data', 'digital', 'neural'],
    'ml':               ['machine learning', 'ai', 'artificial intelligence'],
    'automotive':       ['vehicle', 'car', 'ev', 'electric', 'battery', 'transport'],
    ...
    'medicine':         ['health', 'medical', 'clinical', 'pharmaceutical', 'therapy', 'treatment', 'disease'],
    ...
    'steel':            ['metal', 'manufacturing', 'construction', 'material', 'industrial'],
    'plastic':          ['nanoplastic', 'polymer', 'material', 'pollution', 'recycling'],
